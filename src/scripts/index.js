...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  //      document.getElementById("chatbotContent").innerHTML =
  //        await chatbotInstance.render();
  ...
  //      downBtn.innerHTML =
  //        '<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 9L11 14L16 9" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>';
  ...
  // "chatbotPopOut 0.18s cubic-bezier(.4,1.5,.5,1)";
  // setTimeout(() => {
